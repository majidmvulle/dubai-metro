...
- (void)viewDidLoad
{
    ...
    self.tableView.backgroundColor = MENU_TABLE_COLOR;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (cell == nil) {
        ...
        id customCell = [topLevelObjects lastObject];

        if([customCell isKindOfClass:[UITableViewCell class]]){
            cell = customCell;
        }
    }

    // Configure the cell...
    cell.textLabel.text = [NSString stringWithFormat:@"Item: %d", indexPath.item];
